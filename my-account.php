                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="header_links">
                                            <ul>
                                                ...
                                                <li><a href="wishlist.html" title="wishlist">Danh sách Của Tôi</a></li>
                                            ...
                                            <div class="main_menu d-none d-lg-block">
                                                <nav>
                                                    <ul>
                                                        ...
                                                        <li><a href="shop-1.html">Cửa Hàng</a></li>
                                                            <div class="mega_menu jewelry">
                                                                <div class="mega_items jewelry">
                                                                    <ul>
                                                                        <li><a href="shop-1.html">Cửa hàng chính</a></li>
                                                                        <li><a href="spChiTiet.html">Chi Tiết Sản Phẩm</a></li>
                                        ...
                                        <div class="col-sm-12 col-md-3 col-lg-3">
                                            ...
                                            <div class="dashboard_tab_button">
                                                <ul role="tablist" class="nav flex-column dashboard-list">
                                                    ...
                                                    <li><a href="#downloads" data-toggle="tab" class="nav-link">Danh sách</a></li>
                                        ...
                                        <div class="col-sm-12 col-md-9 col-lg-9">
                                            ...
                                            <div class="tab-content dashboard_content">
                                                <div class="tab-pane fade show active" id="dashboard">
                                                    <h3>Bảng </h3>
                                                    <p>Từ bảng điều khiển bạn có thể dễ dàng kiểm tra &amp; Xem <a href="#">các đơn hàng gần đây</a>, quản lý <a href="#">địa chỉ giao hàng và thanh toán</a> Hoặc <a href="#">Chỉnh sửa mật khẩu và tài khoản của bạn</a></p>
                                                </div>
                                                    ...
                                                    <div class="coron_table table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>1</td>
                                                                    <td>4 tháng 7 2023</td>
                                                                    <td><span class="success">Hoàn Thành</span></td>
                                                                    <td>400.000₫ cho 1 sản phẩm </td>
                                                                    <td><a href="cart.html" class="view">Xem</a></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>4</td>
                                                                    <td>1 tháng 7 2023</td>
                                                                    <td>Đang xử lý</td>
                                                                    <td>200.000₫ cho 4 sản phẩm </td>
                                                                    <td><a href="cart.html" class="view">Xem</a></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <div class="coron_table table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>Helmet Knit</td>
                                                                    <td>4 tháng 5 2023</td>
                                                                    <td><span class="danger">Hết hàng</span></td>
                                                                    <td><a href="#" class="view">Thêm vào giỏ của bạn</a></td>
                                                                </tr>
                                                                <tr>
                                                    ...
                                                    <div class="login">
                                                        <div class="login_form_container">
                                                            <div class="account_login_form">
                                                                <form action="#">
                                                                    <p>Bạn muốn tạo tài khoản?<a href="#">Đăng Nhập</a></p>
